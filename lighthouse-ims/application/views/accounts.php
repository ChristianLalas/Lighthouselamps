...
<body ng-app = "accounts"  ng-controller = "accountsCtrl">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" style=" ">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header wsub" align="center">ACCOUNTS
                ...
                <div class="modal-body">
                    <form name="userFields" ng-submit="submitForm(userFields.$valid)" novalidate>
                        ...
                        <div class="form-group" ng-class="{ 'has-error' : userFields.ContactNo.$invalid && !userFields.ContactNo.$pristine }">
                            ...
                            <input type="text" name="ContactNo" class="form-control" ng-model="ContactNo"  ng-maxlength="11" required>
                        ...
                        <div ng-show="showUsernameAndPass">
                            ...
                            <input class="form-control" id="newPassword" type="password" name="newPassword" ng-model="newPassword" ng-minlength="6" ng-maxlength="15" required>
                            ...
                            <input class="form-control" id="confPassword" type="password" name="confPassword" ng-model="confPassword" ng-minlength="6" ng-maxlength="15" required>
